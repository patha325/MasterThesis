...
\subsection{\abbrLHC}
The Large hadron collider (\abbrLHC) is the a particle accelerator located at \abbrCERN near Geneva in Switzerland, see \ref{fig:lhc}. The accelerator was build to explore physics beyond the standard model and to make more accurate measurements measurements of standard model physics. Before it was shut down for an upgrade in 2012 it was able to accelerate two protons to such a velocity that they had an energy of 6 TeV which give s a center of mass energy of 12 TeV. \textbf{Check facts}. This first upgrade which is scheduled to be completed in 2015 will \textbf{reference!}
\begin{figure}[H]
\begin{center}
...
\end{center}
\end{figure}
Beside the energy of the protons, the  instantaneous Luminosity is an important beam property. \textbf{Continue here}
...
The coordinate system of ATLAS is a right-handed coordinate system with the x-axis pointing towards the centre of the LHC tunnel, and the z-axis along the tunnel/beam (counter clockwise) seen from above. The y-axis points upward.
...
Found at \url{http://www.hep.lu.se/atlas/thesis/egede/thesis-node39.html}
