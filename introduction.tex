...
\end{equation}
where $m_\chi$ is the mass of the \abbrWIMP and M$_*$ is the mass of the mediator. \textbf{It is actually the energy scale where the effective field theory is no longer a good approx.}
