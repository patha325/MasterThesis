...
This is done by looking at the reco data for a given slice at a truth energy or momentum value. Since the smearing functions takes a lot into account the match will not be a fine line as seen in \figureref{fig:tau:2}.
...
Another interesting part is how the effect diminishes with an increasing energy. As seen above, and through the the formula, for the high energies which were of interest here the effect is minimal. 
