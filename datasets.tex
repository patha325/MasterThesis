...
\section{Signals}
\subsection{Qcut}
Qcut means that the original data has been split into different intervals depending on the value of the lead jet pt. Each of the different contributions need to be summed to get the full signal.
