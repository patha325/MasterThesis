...
The signal models are given in \appendixref{sec:appsignals} along with the background models. The two classes of models were introduced \subsectionref{sec:tb:subsec:eft} and will be discussed in more detail in this chapter.
