...
The signal models are given in \appendixref{cha:datasets} along with the background. The different models were discussed in part in \subsectionref{sec:tb:subsec:eft} and some more in this chapter.
...
NEW WITH 350 as SR3 and 500 as SR4 and expected (Scaled to 1000 fb$^{-1}$) thus scaled a factor 100 since luminosity is only a measurement of the amount of data and does not change anything physical.
\begin{table}[ht]
\begin{center}
...
Was discussed in part in \subsectionref{sec:tb:subsec:eft}
