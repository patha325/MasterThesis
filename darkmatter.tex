...
As described in the introduction \subsectionref{sec:tb:subsec:eft}, one of the signals is modelled using the D5 operator. In this thesis two different scenearios were used, one at a dark matter mass of 50 GeV and one at 400 GeV.
...
As described in the introduction \subsectionref{sec:tb:subsec:eft}, the other signal model is a vector mediator model. The data available is: two different widths Mm/3 and Mm/8pi, where Mm denotes the mediator mass and \textbf{the width is ?}
