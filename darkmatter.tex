...
The effect of the high luminosity is seen in the results in \subsectionref{subsec:pilem*}, \subsectionref{subsec:pilemm} and discussed in \subsectionref{subsec:hleff}
...
For the D5 operators as described in \subsectionref{sec:signal:subsec:d5} the mass suppression has been calculated by evaluating at which point the signal is covered by the background. This is done using the two different error models as described in \subsectionref{subsec:figmer} as figures of merit.
